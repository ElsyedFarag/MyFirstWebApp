...
namespace MyShop.DataAccess.Migrations
{
    ...
    [Migration("20240703174606_updateNewMigrationApplicationUSer")]
    partial class updateNewMigrationApplicationUSer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyShop.Entities.Catigory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyShop.Entities.Models.OrderHeader", b =>
                {
                    ...
                    b.Property<DateTime>("PaymentPay")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MyShop.Entities.Models.ShopingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyShop.Entities.Models.Product", b =>
                {
                    b.HasOne("MyShop.Entities.Catigory", "catigory")
                        .WithMany()
                        .HasForeignKey("CatigoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyShop.Entities.Models.ShopingCart", null)
                        .WithMany("Products")
